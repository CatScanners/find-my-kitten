 ...
 * to PX4's EKF2. This means transforming the values and publishing it as
 * another message type. From type:
 * https://docs.ros.org/en/noetic/api/nav_msgs/html/msg/Odometry.html To type:
